...
const Contact = (0, import_index_5a62db6b.c)(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"relative bg-white"}"><div class="${"absolute inset-0"}"><div class="${"absolute inset-y-0 left-0 w-1/2 bg-gray-50"}"></div></div>
	<div class="${"relative max-w-7xl mx-auto lg:grid lg:grid-cols-5"}"><div class="${"bg-gray-50 py-16 px-4 sm:px-6 lg:col-span-2 lg:px-8 lg:py-24 xl:pr-12"}"><div class="${"max-w-lg mx-auto"}"><h2 class="${"text-2xl font-extrabold tracking-tight text-gray-900 sm:text-3xl"}">${(0, import_index_5a62db6b.d)(contactContent.title)}</h2>
				<p class="${"mt-3 text-lg leading-6 text-gray-500"}"><!-- HTML_TAG_START -->${(0, import_marked.parse)(contactContent.content)}<!-- HTML_TAG_END --></p>
				<dl class="${"mt-8 text-base text-gray-500"}"><div><dt class="${"sr-only"}">Regional Location</dt>
						<dd><p>${(0, import_index_5a62db6b.d)(contactContent.location)}</p></dd>
						...
						<dd class="${"flex"}">
							...
							<span class="${"ml-3"}">${(0, import_index_5a62db6b.d)(contactContent.emailAddress)}</span></dd></div></dl></div></div>
